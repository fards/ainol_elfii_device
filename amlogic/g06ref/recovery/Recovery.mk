...
TARGET_RECOVERY_MEDIA_LABEL := "\"Novo7ELF-II\""
...
TARGET_RECOVERY_HAS_SDCARD := true
TARGET_RECOVERY_HAS_UDISK := false

# if display factory test item in UI or not
TARGET_RECOVERY_HAS_FACTORY_TEST := false
