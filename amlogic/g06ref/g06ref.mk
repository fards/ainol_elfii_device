...
PRODUCT_COPY_FILES += \
	device/amlogic/g06ref/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
PRODUCT_COPY_FILES += device/amlogic/g06ref/dhd.ko:system/lib/dhd.ko
PRODUCT_COPY_FILES += device/amlogic/g06ref/mali.ko:root/boot/mali.ko
PRODUCT_COPY_FILES += device/amlogic/g06ref/ump.ko:root/boot/ump.ko
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/../common/res/logo/ainole2.1024x600.rle:root/initlogo.rle.bak \
...
DEVICE_PACKAGE_OVERLAYS := device/amlogic/g06ref/overlay
